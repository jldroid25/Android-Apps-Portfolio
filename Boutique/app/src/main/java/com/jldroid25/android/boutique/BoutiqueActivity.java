...
//Displays list of product that were entered and stored in the app.
public class BoutiqueActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup Floating-Action-Bar to open BoutiqueEditorActivity
        FloatingActionButton fab = findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BoutiqueActivity.this, BoutiqueEditorActivity.class);
        ...
        // If There is no product data yet (until the loader finishes) so pass in null for the Cursor.
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                //For example, the URI would be "content://com.example.android.boutique/boutique/2"
